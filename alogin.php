...
<script>
  ...
  <div>
    <body>
        <div>
            <center><h1 style="background: -webkit-linear-gradient(left, #3931af, #00c6ff); color: #fff; font-family: Arial, Helvetica, sans-serif; font-size: 5rem;">Admin Login</h1></center><br>
              </div> <br>
  </div>
...
if(isset($_POST['signin'])) {
    ...
    $query = "SELECT * FROM a_login WHERE Admin_name='$username' AND Admin_password='$password'";
