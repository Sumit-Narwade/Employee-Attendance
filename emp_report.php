...
<body>
  <div>
    <body>
        <div>
            <center><h1 style="background: -webkit-linear-gradient(left, #3931af, #00c6ff); color: #fff; font-family: Arial, Helvetica, sans-serif; font-size: 5rem; padding: 1 0px;">Employee Report</h1></center><br>
              </div>
  </div>
   ...
   <div class="text-field-container">
        <table class="t1">
             ...
             <tr>
                ...
                <th>
                    <div class="col-md-81"><input type="text" placeholder="Enter ID"  name="employee_id" class="text-field" id="employee_id"></div><br><br>
