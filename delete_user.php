...
<body>
  <div>
    ...
    <center><h1 style="background: -webkit-linear-gradient(left, #3931af, #00c6ff); color: #fff; font-family: Arial, Helvetica, sans-serif; font-size: 5rem; padding: 1 0px;">Delete Employee</h1></center><br>
     ...
     <center>
        ...
        <table class="t1">
             ...
             <tr>
                ...
                <th>
                    <div>
                        <input type="submit" class="btn" id="button1" name="createbtn" value="Delete Empolyee">
                      </div>
                </th>
             </tr>
...
if (isset($_POST['createbtn'])) {
    ...
    $sql = "DELETE FROM u_login WHERE Employee_id='$id'";
